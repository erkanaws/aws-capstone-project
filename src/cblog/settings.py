...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/erki/capstone/username')
    password_param = ssm.get_parameter(Name="/erki/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cnxbphrehdal.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'erki-capstone-static' # please enter your s3 bucket name
